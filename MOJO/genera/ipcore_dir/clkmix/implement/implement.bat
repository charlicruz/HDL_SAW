...
xst -ifn xst.scr
move clkmix_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkmix_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkmix_exdes.ucf clkmix_exdes

echo 'Running map'
map -timing -pr b clkmix_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkmix_exdes -w routed.ncd routed.vhd
cd ..
